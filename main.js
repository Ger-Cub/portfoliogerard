...
const translations = {
    en: {
        ...
        "about.geoai.text": "I build AI-powered geospatial solutions using satellite imagery, deep learning, and cloud platforms. Founder of GeoCongo AI — a platform deploying foundation models (Prithvi, SAM2) for landcover classification, landslide detection, and mineral prospecting in Central Africa.",
        ...
        "about.geoai.l4": "Landcover & Change Detection",
        ...
        "exp.rs.desc": "Processing SAR and multispectral satellite imagery, deploying foundation AI models for landcover mapping, change detection, and hazard assessment in Central Africa.",
        ...
        "proj.geocongo.desc": "AI-powered geospatial intelligence platform for Central Africa. Deploys foundation models (Prithvi, SAM2) for landcover classification, landslide detection, and mineral prospecting using satellite imagery on Google Cloud Vertex AI.",
        "proj.landslide.title": "Landslide Mapping — Katana",
        "proj.landslide.desc": "Satellite-based spatial analysis and distribution mapping of landslide hazards in the Katana territory, South Kivu.",
        "proj.yetubook.desc": "Digital platform for local publishers and readers. Full-stack web application with e-commerce features.",
    ...
    fr: {
        ...
        "about.geoai.text": "Je construis des solutions géospatiales propulsées par l'IA en utilisant l'imagerie satellitaire, le deep learning et des plateformes cloud. Fondateur de GeoCongo AI — une plateforme déployant des modèles fondationnels (Prithvi, SAM2) pour la classification du couvert terrestre, la détection de glissements de terrain et la prospection minière en Afrique centrale.",
        ...
        "about.geoai.l4": "Classification du couvert et détection de changements",
        ...
        "exp.rs.desc": "Traitement d'images satellites SAR et multispectrales, déploiement de modèles IA fondationnels pour la cartographie du couvert terrestre, la détection de changements et l'évaluation des risques en Afrique centrale.",
        ...
        "proj.geocongo.desc": "Plateforme d'intelligence géospatiale propulsée par l'IA pour l'Afrique centrale. Déploie des modèles fondationnels (Prithvi, SAM2) pour la classification du couvert terrestre, la détection de glissements de terrain et la prospection minière via Google Cloud Vertex AI.",
        "proj.landslide.title": "Cartographie Glissements — Katana",
        "proj.landslide.desc": "Analyse spatiale par satellite et cartographie de la distribution des risques de glissements de terrain dans le territoire de Katana, Sud-Kivu.",
        "proj.yetubook.desc": "Plateforme numérique pour éditeurs et lecteurs locaux. Application web full-stack avec fonctionnalités e-commerce.",
...
const botData = {
    en: {
        ...
        geocongo: {
            messages: [
                "🌍 **GeoCongo AI** is an AI-powered geospatial intelligence platform for Central Africa.",
    ...
    fr: {
        ...
        geocongo: {
            messages: [
                "🌍 **GeoCongo AI** est une plateforme d'intelligence géospatiale pour l'Afrique centrale.",
                "Elle déploie des modèles fondationnels comme **Prithvi** et **SAM2** sur Google Cloud Vertex AI pour :",
                "• 🗺️ Classification du couvert terrestre\n• ⛰️ Détection de glissements de terrain\n• 💎 Prospection minérale",
